...
First implementation.
  ...
  model PhotovoltaicSystem_26trips_offboat_no_external_battery_charger
    ...
    Modelica.Blocks.Sources.Constant const(k=0)
      annotation (Placement(transformation(extent={{-52,8},{-42,18}})));
  ...
  equation
    ...
    connect(const.y, switch1.u3) annotation (Line(points={{-41.5,13},{-36,13},{
            -36,20.8},{-30.8,20.8}}, color={0,0,127}));
...
First implementation.
  ...
  end PhotovoltaicSystem_26trips_offboat_no_external_battery_charger;
end System;
