...
model PhotovoltaicSystem_26trips_offboat_external_battery_charger
  "PV system for a solar boat"
  ...
  Modelica.Blocks.Sources.CombiTimeTable Load_profile_Engine(extrapolation=
        Modelica.Blocks.Types.Extrapolation.Periodic, table=[0,0.0001; 29700,
        0.0001; 29700,2200; 29970,2200; 29970,0.0001; 30270,0.0001; 30270,1500;
        ...
        0.0001; 63330,0.0001; 63330,1500; 63600,1500; 63600,0.0001; 86399,
        0.0001])
  ...
  Modelica.Blocks.Logical.Switch switch1
    annotation (Placement(transformation(extent={{-30,20},{-22,28}})));
  Modelica.Blocks.Sources.Pulse Battery_charger(
    amplitude=500,
    period=86400,
    offset=0,
    startTime=63660,
    width=41.66667) "48_volt_500Watts"
...
equation
  ...
  connect(pvField.PField, EField.u) annotation (Line(points={{-40,52},{-40,80},
          {-36.8,80}},         color={0,0,127}));
  ...
  connect(Load_profile_Engine.y[1], load.u) annotation (Line(points={{33.4,48},
          {30,48},{30,52},{27.2,52}}, color={0,0,127}));
  connect(load.y, lessEqualThreshold.u) annotation (Line(points={{13.4,52},{10,
          52},{10,31},{15,31}}, color={0,0,127}));
  connect(pvField.PField, switch1.u1) annotation (Line(points={{-40,52},{-34,52},
          {-34,27.2},{-30.8,27.2}}, color={0,0,127}));
  connect(lessEqualThreshold.y, switch1.u2) annotation (Line(points={{26.5,31},
          {30,31},{30,8},{-34,8},{-34,24},{-30.8,24}}, color={255,0,255}));
  connect(switch1.y, battery.PCharge) annotation (Line(points={{-21.6,24},{-18,
          24},{-18,34},{-30,34},{-30,52},{-25,52}}, color={0,0,127}));
  connect(Battery_charger.y, switch1.u3) annotation (Line(points={{-73,24},{-52,
          24},{-52,20.8},{-30.8,20.8}}, color={0,0,127}));
...
end PhotovoltaicSystem_26trips_offboat_external_battery_charger;
